...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_moe_w13_matvec \
    ...
    "${SCRIPT_DIR}/corex_moe_w13_matvec_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX custom W13 matvec probe %s\n' "${OUTPUT}"

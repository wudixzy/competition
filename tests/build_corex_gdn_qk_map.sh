...
"${COREX_ROOT}/bin/clang++" \
    ...
    "${SCRIPT_DIR}/corex_gdn_qk_map_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX GDN q/k map probe %s\n' "${OUTPUT}"

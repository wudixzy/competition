...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_moe_pairwise_w13 \
    ...
    "${SCRIPT_DIR}/corex_moe_pairwise_w13_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX pairwise W13 probe %s\n' "${OUTPUT}"

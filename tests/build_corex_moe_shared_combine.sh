...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_moe_shared_combine \
    ...
    "${SCRIPT_DIR}/corex_moe_shared_combine_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX MoE shared-combine probe %s\n' "${OUTPUT}"

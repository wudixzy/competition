...
"${COREX_ROOT}/bin/clang++" \
    ...
    "${SCRIPT_DIR}/corex_moe_compensated_w13_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX compensated W13 probe %s\n' "${OUTPUT}"

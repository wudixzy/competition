...
"${COREX_ROOT}/bin/clang++" \
    ...
    "${SCRIPT_DIR}/corex_moe_direct_routed_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX direct routed-expert probe %s\n' "${OUTPUT}"

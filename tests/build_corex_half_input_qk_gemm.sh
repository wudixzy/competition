...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_half_input_qk_gemm \
    ...
    "$ROOT/tests/corex_half_input_qk_gemm_ext.cu" \
...
test -s "$OUTPUT"
printf '[ok] CoreX half-input QK capability extension %s\n' "$OUTPUT"

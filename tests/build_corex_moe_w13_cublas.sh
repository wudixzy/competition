...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_moe_w13_cublas \
    ...
    "${SCRIPT_DIR}/corex_moe_w13_cublas_ext.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX contiguous W13 cuBLAS probe %s\n' "${OUTPUT}"

...
"${COREX_ROOT}/bin/clang++" \
    ...
    "${SCRIPT_DIR}/corex_fused_paged_prefill.cu" \
...
test -s "${OUTPUT}"
printf '[ok] CoreX fused paged-prefill extension %s\n' "${OUTPUT}"

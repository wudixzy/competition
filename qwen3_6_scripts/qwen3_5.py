...
from vllm.bi100_profile import (bi100_profile_event_enabled,
                                bi100_profile_flush, bi100_timer)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if bi100_profile_event_enabled():
            ...
            profile_context_lens = getattr(
                attn_metadata, "context_lens_tensor", None)
            if (profile_prefill_tokens > 0
                    and profile_context_lens is not None
                    and profile_context_lens.numel() > 0):
                profile_context_len = int(profile_context_lens[0].item())
            bi100_profile_flush(

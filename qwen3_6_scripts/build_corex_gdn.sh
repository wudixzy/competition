...
"${COREX_ROOT}/bin/clang++" \
    ...
    -DTORCH_EXTENSION_NAME=corex_gdn_recurrent \
...
test -s "${OUTPUT}"
printf '[ok] CoreX GDN extension %s\n' "${OUTPUT}"

...
| `BI100_GEMMA_COREX_RMS_NORM` | `1` | boolean | Enables exact T=1, FP16, H=2048 Gemma residual/RMSNorm elementwise fusion while preserving the PyTorch mean/rsqrt reduction. | E-NORM-01 |

...
| `BI100_MOE_COREX_WEIGHT_GATHER` | `1` | boolean | Enables the exact half2 CoreX gather of selected FP16 top-8 routed-expert weights in the T=1 decode path; set to `0` for native advanced indexing. | E-MOE-12 |
